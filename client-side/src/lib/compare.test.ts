...
describe('compare helpers', () => {
    ...
    it('resolves compare history product ids from multiple shapes', () => {
        expect(getComparisonHistoryProductId({ product: 'product-1' } as never)).toBe('product-1');
        expect(getComparisonHistoryProductId({ product: { _id: 'product-2' } } as never)).toBe('product-2');
        expect(getComparisonHistoryProductId({ _id: 'record-3' } as never)).toBe('record-3');
    });
    ...
    it('enforces max items and same category in the UI helper', () => {
        ...
        expect(canAddToCompare(products, {
            id: 'product-5',
            title: 'Product 5',
            slug: 'product-5',
            href: '/shop',
        ...
        expect(canAddToCompare(products.slice(0, 1), {
            id: 'product-6',
            title: 'Product 6',
            slug: 'product-6',
            href: '/shop',
