...
describe('form validation schemas', () => {
    it('validates forgot password flow fields', () => {
        expect(authFormSchemas.forgotPassword.safeParse({ email: 'USER@EXAMPLE.COM' }).success).toBe(true);
        expect(authFormSchemas.forgotPasswordOtp.safeParse({ otp: '123456' }).success).toBe(true);
        expect(
