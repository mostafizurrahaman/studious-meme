...
export default async function AdminCartPage({ searchParams }: Props) {
    ...
    return <DashboardCartManager records={records} paginationMeta={paginationMeta} />;
}
