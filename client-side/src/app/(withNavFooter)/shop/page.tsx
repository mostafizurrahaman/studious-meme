                            ...
                            <div className="mt-4 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                                <div>
                                    ...
                                    <p className="mt-3 max-w-2xl text-sm leading-7 text-white/78 sm:text-base">
                                        Browse the storefront catalog with filters, categories and product
                                        cards across the full hardware range.
                                    </p>
                                </div>
                        ...
                        <Card className="hidden p-5 shadow-sm lg:block">
                            ...
                            <div className="mt-4 space-y-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="mt-2 text-foreground/65">Tk. 500 - Tk. 120,000</div>
                                </div>
                            </div>
                        </Card>
                            ...
                            <Card className="p-4 shadow-sm">
                                <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                                    <div className="text-sm text-foreground/65">
                                        Showing {products.length} products across {backendCategories.length}{' '}
                                        categories
                                    </div>
                                    <div className="flex flex-wrap gap-2 text-xs font-semibold">
                                        {['All', 'Sale', 'Featured', 'Latest', 'Industrial', 'Home'].map(
                                            tag => (
                                                <span
                                                    key={tag}
