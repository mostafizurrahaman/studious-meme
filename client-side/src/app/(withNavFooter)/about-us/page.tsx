        ...
        <ManagedPageContent
            ...
            fallback={
                <div className="grid gap-4 text-sm leading-7 text-foreground/70">
                    <p>
                        Malamal helps customers browse hardware, tools, and home improvement products with a
                        clean shopping experience.
                    </p>
                    <p>
                        This page can be fully managed from the dashboard by admins and super admins.
                    </p>
                </div>
            }
        />
