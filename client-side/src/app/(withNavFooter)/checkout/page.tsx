      ...
      {paymentState ? (
        <main className="bg-background px-4 pt-6">
          <div className="mx-auto max-w-310">
            <Card className={`p-4 text-sm font-semibold shadow-sm ${paymentState === 'success' ? 'border-emerald-500/30 bg-emerald-50 text-emerald-700' : paymentState === 'failed' ? 'border-destructive/30 bg-destructive/5 text-destructive' : 'border-amber-500/30 bg-amber-50 text-amber-700'}`}>
