...
type QuotationRequestErrors = Partial<Record<'name' | 'email' | 'phone' | 'products' | 'message', string>>;
...
function flattenErrors(error: z.ZodError<z.infer<typeof quotationRequestSchema>>) {
