        ...
        <div className="mx-auto w-full max-w-350 px-4 py-6 lg:px-6">
          ...
          <section className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {topCategories.map(category => (
              ...
              >
                <div className="text-lg font-extrabold text-[#0e2f56]">
                  {category.name}
                </div>
          ...
          <section className="mt-10 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {categoryShowcase.map(card => (
              ...
              >
                ...
                <Button className="mt-6 w-fit rounded-full bg-white/18 px-4 py-2 text-sm font-semibold text-white backdrop-blur-sm hover:bg-white/24">
                  Explore category
                </Button>
              </Link>
            ))}
