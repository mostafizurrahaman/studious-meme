    ...
    <form ref={formRef} action={formAction} noValidate className="grid gap-4">
      <div className="grid gap-4 md:grid-cols-2">
        <label className="grid gap-2 text-sm font-semibold text-foreground">
          Full name
          <Input name="name" placeholder="Your name" aria-invalid={Boolean(state.errors?.name)} />
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <label className="grid gap-2 text-sm font-semibold text-foreground">
          Phone
          <Input name="phone" placeholder="01XXXXXXXXX" aria-invalid={Boolean(state.errors?.phone)} />
      ...
      <label className="grid gap-2 text-sm font-semibold text-foreground">
        ...
        <Textarea
          ...
          className="min-h-32"
          aria-invalid={Boolean(state.errors?.products)}
        />
        <FieldError message={state.errors?.products} />
      </label>
      <label className="grid gap-2 text-sm font-semibold text-foreground">
        Brand preference
        <select
