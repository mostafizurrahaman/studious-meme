        ...
        <details className="group relative hidden md:block">
            ...
            <Card className="absolute right-0 top-full z-30 mt-3 w-90 p-4 shadow-2xl">
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-xs font-semibold text-foreground/55">{count} items</div>
                </div>
                <div className="mt-4 space-y-3">
                    {items.length > 0 ? (
                        items.slice(0, 3).map(item => (
                            <div key={item.sku} className="flex gap-3 rounded-2xl border border-border p-3">
                                ...
                                <div className="min-w-0 flex-1">
                                    ...
                                    <div className="mt-1 text-xs text-foreground/55">Qty {item.quantity}</div>
                                </div>
