      ...
      {paginationMeta.total > 0 ? (
        <div className="border-t p-4">
          <TablePagination
            ...
            onPageChange={(page) => router.push(`/dashboard/user/payments?page=${page}&limit=${paginationMeta.limit}`)}
            onLimitChange={(limit) => router.push(`/dashboard/user/payments?page=1&limit=${limit}`)}
          />
        </div>
      ) : null}
    </Card>
