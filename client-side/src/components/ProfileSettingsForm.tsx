    ...
    <div className="grid gap-4 lg:grid-cols-2">
      <Card className="shadow-sm">
        ...
        <CardContent className="grid gap-3">
          <div className="flex items-center gap-4 rounded-2xl border border-border/70 bg-muted/30 p-4">
            <UserAvatar name={profileName} image={imagePreview} className="size-16" />
            <div className="min-w-0 flex-1">
              <div className="text-sm font-semibold text-foreground">Profile photo</div>
              <div className="text-xs text-muted-foreground">Upload a new photo for your account avatar.</div>
      ...
      <Card className="shadow-sm">
        ...
        <CardContent className="grid gap-3">
          ...
          <ErrorText message={passwordForm.formState.errors.oldPassword?.message} />
          <div className="relative">
            <Input
