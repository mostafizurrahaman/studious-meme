                        ...
                        <TableBody>
                            {sortedAdmins.map(admin => {
                                ...
                                <TableRow key={admin._id ?? admin.email}>
                                    ...
                                    <TableCell>
                                        {isEditing ? (
                                            <Input value={editingForm.email} onChange={e => setEditingForm({ ...editingForm, email: e.target.value })} />
                                        ) : admin.email}
                                    </TableCell>
                                    <TableCell>
                                        {isEditing ? (
                                            <Input value={editingForm.phone} onChange={e => setEditingForm({ ...editingForm, phone: e.target.value })} />
                                        ) : (admin.phone || '-')}
                                    </TableCell>
                                    <TableCell>
                                        {isEditing ? (
                                            <select
                                                ...
                                                onChange={e => setEditingForm({ ...editingForm, isActive: e.target.value === 'true' })}
                                            ...
                                            <Badge variant="secondary">{admin.isActive === false ? 'Inactive' : 'Active'}</Badge>
                                        )}
                                    </TableCell>
                                                ...
                                                <>
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            if (!adminId) return;
                                                            startTransition(async () => {
                                                                const result = await updateAdmin(adminId, editingForm);
                                                                if (!result?.success) {
