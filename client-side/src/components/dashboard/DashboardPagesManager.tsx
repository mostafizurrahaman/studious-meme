...
const textColors = ['#111827', '#2563eb', '#15803d', '#b91c1c', '#c2410c', '#7c3aed'];
const highlightColors = ['#ffffff', '#fef3c7', '#dcfce7', '#dbeafe', '#fee2e2', '#f3e8ff'];
