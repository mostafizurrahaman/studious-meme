        ...
        <div className="grid gap-10 py-12 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm text-secondary-foreground/90">
              <Link className="hover:text-secondary-foreground" href="/shop">Shop</Link>
              <Link className="hover:text-secondary-foreground" href="/promotions">Promotions</Link>
              <Link className="hover:text-secondary-foreground" href="/main-categories">Main Categories</Link>
              <Link className="hover:text-secondary-foreground" href="/shop-by-brands">Shop By Brands</Link>
              <Link className="hover:text-secondary-foreground" href="/quotation-request">Quotation Request</Link>
              <Link className="hover:text-secondary-foreground" href="/our-contacts">Our Contacts</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm text-secondary-foreground/90">
              {topCategories.slice(0, 4).map(category => (
                <Link key={category.name} className="hover:text-secondary-foreground" href={category.href}>
                  {category.name}
                </Link>
              ))}
              <Link className="hover:text-secondary-foreground" href="/my-account">My Account</Link>
              <Link className="hover:text-secondary-foreground" href="/wishlist">My Wishlist</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 grid gap-2 text-sm text-secondary-foreground/90">
              {contactChannels.map(channel => (
                <a key={channel.label} className="hover:text-secondary-foreground" href={channel.href}>
