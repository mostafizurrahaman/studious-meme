...
export function CategoryPageClient({ category, products, brands, meta }: Props) {
  ...
  return (
    <>
      ...
      >
        <p className="text-xs font-semibold uppercase tracking-[0.3em] text-white/65">Category page</p>
        <h1 className="mt-4 text-3xl font-black sm:text-4xl">{title}</h1>
        <p className="mt-3 max-w-3xl text-sm leading-7 text-white/78 sm:text-base">{category.description}</p>
      </section>
