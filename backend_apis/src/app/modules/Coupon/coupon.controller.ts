...
const getCoupon = asyncHandler(async (req, res) => {
    const result = await CouponService.getCouponByIdFromDB(getSingleParam(req.params.couponId));
...
const updateCoupon = asyncHandler(async (req, res) => {
    const result = await CouponService.updateCouponIntoDB(getSingleParam(req.params.couponId), req.body);
...
const deleteCoupon = asyncHandler(async (req, res) => {
    const result = await CouponService.deleteCouponFromDB(getSingleParam(req.params.couponId));
