...
import { deleteImageFromCloudinary, generateOtp, sendImageToCloudinary } from '../../lib';
...
const updateAdminIntoDB = async (
    ...
    const existingAdmin = await UserModel.findOne({ _id: userId, role: ROLE.ADMIN }).select('image');
    ...
    try {
        ...
        if (uploadedImage && existingAdmin.image && existingAdmin.image !== uploadedImage) {
