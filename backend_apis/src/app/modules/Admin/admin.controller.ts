...
const getAllAdmins = asyncHandler(async (_req, res) => {
    ...
    sendResponse(res, { statusCode: httpStatus.OK, message: 'Admins fetched successfully!', data: result });
});

const getAdmin = asyncHandler(async (req, res) => {
    const result = await AdminService.getAdminByIdFromDB(getSingleParam(req.params.userId));
    sendResponse(res, { statusCode: httpStatus.OK, message: 'Admin fetched successfully!', data: result });
});
...
const deleteAdmin = asyncHandler(async (req, res) => {
    const result = await AdminService.deleteAdminFromDB(getSingleParam(req.params.userId));
    sendResponse(res, { statusCode: httpStatus.OK, message: 'Admin deleted successfully!', data: result });
});

export const AdminController = { createAdmin, getAllAdmins, getAdmin, updateAdmin, deleteAdmin };
