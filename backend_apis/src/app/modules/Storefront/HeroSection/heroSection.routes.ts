...
router
    .route('/heroes')
    .post(auth(ROLE.ADMIN, ROLE.SUPER_ADMIN), validateRequest(HeroSectionValidation.heroSectionCreateSchema), HeroSectionController.createHeroSection)
    .get(HeroSectionController.getAllHeroSections);

router
    .route('/heroes/:heroSectionId')
    .get(HeroSectionController.getHeroSection)
    .patch(auth(ROLE.ADMIN, ROLE.SUPER_ADMIN), validateRequest(HeroSectionValidation.heroSectionUpdateSchema), HeroSectionController.updateHeroSection)
