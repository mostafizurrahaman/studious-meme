...
router.route('/brands/active').get(publicLimiter, BrandController.getActiveBrands);
router.route('/brands/active/:slug').get(publicLimiter, BrandController.getActiveBrand);
...
router
    ...
    .delete(auth(ROLE.ADMIN, ROLE.SUPER_ADMIN), adminLimiter, BrandController.deleteBrand);
