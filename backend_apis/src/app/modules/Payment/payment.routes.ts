...
router.route('/portpos/ipn').post(paymentWebhookGuard, PaymentController.portPosIpn);
...
router
  .route('/admin')
  .get(auth(ROLE.ADMIN, ROLE.SUPER_ADMIN), adminLimiter, PaymentController.getAllPaymentsForAdmin);
