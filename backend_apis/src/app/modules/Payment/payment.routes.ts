...
router
    ...
    .post(PaymentController.sslCommerzSuccess)
    .get(PaymentController.sslCommerzSuccess);
...
router
    ...
    .post(PaymentController.sslCommerzCancel)
    .get(PaymentController.sslCommerzCancel);

router.route('/sslcommerz/ipn').post(PaymentController.sslCommerzSuccess);

router
    .route('/my-payments')
    .get(auth(ROLE.USER, ROLE.ADMIN, ROLE.SUPER_ADMIN), PaymentController.getMyPayments);
